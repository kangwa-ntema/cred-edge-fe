  // fe/src/components/PlatformAdminDashboard/AccountingDashboard/FinancialHub/LedgerTab/LedgerTab.tsx
            ...
            <tbody>
              {generalLedger.map(entry => (
                <tr key={entry._id}>
                  ...
                  <td className="text-right balance">{formatCurrency(entry.balance || 0)}</td>
                </tr>
              ))}
            </tbody>
          </table>
